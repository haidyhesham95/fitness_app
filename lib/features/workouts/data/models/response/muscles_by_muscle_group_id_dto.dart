...
class MusclesByMuscleGroupIdResponseDto {
  ...
  MusclesByMuscleGroupIdResponseDto(this.message, this.totalMuscles, this.muscles);

  factory MusclesByMuscleGroupIdResponseDto.fromJson(Map<String, dynamic> json) =>
