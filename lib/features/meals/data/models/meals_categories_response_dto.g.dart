...
Map<String, dynamic> _$MealsCategoriesResponseDtoToJson(
        MealsCategoriesResponseDto instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$MealsCategoriesDtoToJson(MealsCategoriesDto instance) =>
    <String, dynamic>{
