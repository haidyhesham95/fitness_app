class GetRandomExercisesResponseEntity {
  final String? message;
  final int? totalExercises;
  final List<GetRandomExercisesResponseEntityExercises?>? exercises;

  GetRandomExercisesResponseEntity(
      this.message, this.totalExercises, this.exercises);
}

class GetRandomExercisesResponseEntityExercises {
  final String? id;
  ...
  GetRandomExercisesResponseEntityExercises(
      this.id,
      this.exercise,
