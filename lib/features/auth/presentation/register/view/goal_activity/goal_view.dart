...
class GoalView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomGoalView(
      ...
      progress: 0.8,
      items: {
        LangKeys.gainWeight: context.translate(LangKeys.gainWeight),
        LangKeys.loseWeight: context.translate(LangKeys.loseWeight),
        LangKeys.getFitter: context.translate(LangKeys.getFitter),
        LangKeys.gainMoreFlexible: context.translate(LangKeys.gainMoreFlexible),
        LangKeys.trueBeast: context.translate(LangKeys.trueBeast),
      },
