...
void main() {
  ...
  setUp(
      ...
      provideDummy <DataResult<List<MealEntity>>>(Success<List<MealEntity>>(DummyMealsHelper.mealsList));

    },
  );
  test('when getMealsCategoriesCase is called', () async {

    when(mockMealsRepository.getMealsByCategory(any)).thenAnswer((_) async => await Success<List<MealEntity>>(DummyMealsHelper.mealsList));
