...
void main() {
  ...
  setUp(
      ...
      provideDummy <DataResult<MealDetailsEntity>>(Success<MealDetailsEntity>(DummyMealsHelper.mealDetailsEntity));

    },
  );
  test('when getMealsCategoriesCase is called', () async {

    when(mockMealsRepository.getMealById(any)).thenAnswer((_) async => await Success<MealDetailsEntity>(DummyMealsHelper.mealDetailsEntity));
