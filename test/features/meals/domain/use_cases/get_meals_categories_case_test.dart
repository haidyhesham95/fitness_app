...
void main() {
  ...
  setUp(
      ...
      provideDummy <DataResult<List<MealsCategoryEntity>>>(Success<List<MealsCategoryEntity>>(DummyMealsHelper.mealsCategoryList));

    },
  );
  test('when getMealsCategoriesCase is called', () async {

    when(mockMealsRepository.getMealsCategories()).thenAnswer((_) async => await Success<List<MealsCategoryEntity>>(DummyMealsHelper.mealsCategoryList));
