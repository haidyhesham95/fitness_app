  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () async {
          List<MealEntity> expected =
              MealsDtoMapper.toMealsEntity(
          ...
          when(mockApiManager.getMealsByCategory( '1'))
              .thenAnswer((_) async => await DummyMealsHelper.mealsByCategoryResponseDto);
      ...
      test(
        ...
        () async {
          MealDetailsEntity expected =
              MealsDtoMapper.toMealDetailsEntity(
          ...
          when(mockApiManager.getMealById( '1'))
              .thenAnswer((_) async => await DummyMealsHelper.mealsDetailsResponseDto);
