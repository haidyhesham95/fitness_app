...
void main() {
  ...
  setUp(() {
    ...
    workoutsViewModelCubit =
        WorkoutsViewModelCubit(mockWorkoutsUseCase, mockGetWorkoutsByIdUseCase);
    provideDummy<DataResult<AllMusclesResponseEntity>>(
        Success(allMuscleResponseEntity));
    provideDummy<DataResult<MusclesByIdResponseEntity>>(
        Success(musclesByIdResponseEntity));
  });

  group(
      'when call doAction function it should call getAllWorkouts and getWorkoutsById from useCases and change state with the right and left sequences ',
      () {
    ...
    blocTest<WorkoutsViewModelCubit, WorkoutsViewModelState>(
      ...
      build: () {
        ...
        when(mockWorkoutsUseCase.getAllWorkouts())
            .thenAnswer((_) async => mockedResult);
        return workoutsViewModelCubit;
      },
      act: (workoutsViewModelCubit) =>
          workoutsViewModelCubit.doAction(GetAllWorkouts()),
      expect: () => [
...
// test get all muscle by id success
    blocTest<WorkoutsViewModelCubit, WorkoutsViewModelState>(
      ...
      act: (workoutsViewModelCubit) =>
          workoutsViewModelCubit.doAction(GetWorkoutsById('1')),
      expect: () => [
  ...
  blocTest<WorkoutsViewModelCubit, WorkoutsViewModelState>(
    ...
    build: () {
      var mockedResult =
          Fail<AllMusclesResponseEntity>(Exception('Invalid credentials'));
  ...
  blocTest<WorkoutsViewModelCubit, WorkoutsViewModelState>(
    ...
    build: () {
      var mockedResult =
          Fail<MusclesByIdResponseEntity>(Exception('Invalid credentials'));
