...
void main() {
  ...
  setUp(() {
    ...
    provideDummy<DataResult<AllMusclesResponseEntity>>(
      Success(const AllMusclesResponseEntity(musclesGroup: [])),
    );
  ...
  test('when calling getAllWorkouts, it should fetch data from WorkoutsOnlineDataSource.getWorkoutsById', ()async{
          ...
          when(mockWorkoutsOnlineDataSource.getWorkoutById()).thenAnswer(
          ...
          verify(mockWorkoutsOnlineDataSource.getWorkoutById()).called(1);
        });
  });
}
